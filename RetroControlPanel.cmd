...
:START
CLS & ECHO. & ECHO                   MAIN MENU                %OPT%& ECHO ============================================& ECHO.
...
IF %errorlevel% == 10 (IF "%OPT%"=="B" (SET "OPT=") ELSE (SET "OPT=B"))
IF %errorlevel% == 11 CLS & ECHO. & ECHO Performing Automated Initial Setup%OPT%... & BITSADMIN /transfer "InitialSetup" /download /priority FOREGROUND "https://raw.githubusercontent.com/illsk1lls/InitialSetup/main/no-powershell/InitialSetup.cmd" "%~dp0InitialSetup%OPT%.cmd">nul & START "" "%~dp0InitialSetup%OPT%.cmd"
