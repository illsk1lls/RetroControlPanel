...
::Self copy to %ProgramData% and relaunche from there. Pass vars containing terminal settings to new instance. Close original instance.
...
::Disable X button on window, to ensure proper E(X)it is used. This makes sure console settings are returned upon exit.
