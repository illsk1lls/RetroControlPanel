...
::Disable X button on window, and center window. X Button is disabled to ensure proper E(X)it is used. This makes sure console settings are returned upon exit.
